# Generated by Django 2.0 on 2018-05-02 09:17
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('description', models.CharField(help_text='Short Description for Test ', max_length=5000)),
                ('name', models.CharField(choices=[('VOIP_TEST', 'VOIP_TEST'), ('DATA_LAN_LAN', 'DATA_LAN_LAN'), ('DATA_LAN_WLAN_2.4_Ghz', 'DATA_LAN_WLAN_2.4_Ghz'), ('DATA_LAN_WLAN_5_Ghz', 'DATA_LAN_WLAN_5_Ghz'), ('DATA_WAN_WLAN_5_Ghz', 'DATA_WAN_WLAN_5_Ghz'), ('IPTV_WLAN_5_Ghz', 'IPTV_WLAN_5_Ghz'), ('P2P_WLAN_5_Ghz', 'P2P_WLAN_5_Ghz'), ('IPTV_LAN', 'IPTV_LAN'), ('WEBUI', 'WEBUI')], max_length=50, unique=True)),
